                ...
                <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                    ...
                    <div className="main-box border border-gray-200 rounded-xl shadow-lg pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                        <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
                            <div className="data">
                                <p className="font-semibold text-base leading-7 text-black">
                                    Commande No: <span className="text-gray-500">#10234987</span>
                                </p>
                                <p className="font-semibold text-base leading-7 text-black mt-4">
                                    Date Commande : <span className="text-gray-500 font-medium">18 mai 2024</span>
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
                                        <div className="flex items-center">
                                            <div>
                                                ...
                                                <p className="font-semibold text-lg leading-8 mb-3">Prix: <span className="text-gray-500">2000f</span> </p>
                                                <div className="flex items-center">
                                                    <button
                                                    ...
                                                    Temps estimé: <span className="text-gray-500">3 heures</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between">
                            ...
                            <button className="flex items-center inline-flex items-center md:ml-4 rounded-lg py-3 px-8 font-semibold text-sm leading-7 text-white bg-red-700 max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-red-500 hover:shadow-red-400">
                            ...
                            <p className="font-semibold text-lg text-black py-6">
                                Prix Total: <span className="text-gray-500">2000 franc</span>
                            </p>
                        </div>
                    </div>
                </div>
